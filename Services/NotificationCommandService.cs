...
namespace NotificationsService.DatabaseActions
{
    public class NotificationCommandService : INotificationCommandsService
    {
        private readonly IAmazonDynamoDB amazonDynamoDB;
        private const string TableName = "notifications";

        public NotificationCommandService(IDynamoDbConfigure dynamoDbConfigure)
        {
